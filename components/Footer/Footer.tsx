...
// test with both StoryCard and TravellerCard components
      ...
      <div className="container ">
        <div className={styles.mainRow}>
          ...
          <nav className={styles.nav}>
            ...
            <Link href="/stories" className="link-base link-text link-footer-pc link-footer-mobile">
              Історії
            </Link>
        ...
        {/* Тестове відображення користувача */}
        <div
          style={{
            display: 'flex',
            flexWrap: 'wrap',
