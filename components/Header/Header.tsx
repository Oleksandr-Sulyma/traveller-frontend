    ...
    <header className={headerClasses}>
      <div className={`container ${css.container}`}>
        ...
        <div className={css.actionsGroup}>
          {/* ДЕСКТОП (1440px+) - Повний AuthNavigation */}
          <div className={css.desktopAuthOnly}>
            <AuthNavigation mode="desktop" onCloseAction={closeMenu} />
          </div>

          {/* ПЛАНШЕТ (768px-1439px) - Тільки кнопка */}
          <div className={css.tabletAuthVisible}>
            <AuthNavigation mode="tablet" onCloseAction={closeMenu} />
          </div>

          {/*  МОБІЛЬНИЙ (<768px) - Тільки бургер */}
